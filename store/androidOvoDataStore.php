<?php
    ...
    $sql = "SELECT A.id, A.provider, A.provider_sub, A.code, A.description, A.price, 350 AS transaksi, A.jual, B.logo FROM ppob_produk AS A, ppob_provider AS B WHERE A.provider=B.kode AND A.provider='OVO' ORDER BY A.jual";
