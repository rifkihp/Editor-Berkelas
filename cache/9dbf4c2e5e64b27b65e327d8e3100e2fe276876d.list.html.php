...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_6670345d81f973_61686708',
  'has_nocache_code' => false,
  'cache_lifetime' => 0,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6670345d81f973_61686708')) {function content_6670345d81f973_61686708($_smarty_tpl) {?><!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
    ...
    <div class="header">
        <div class="header-content">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="http://localhost/editorberkelas/adminweb/banner/">Kategori</a></li>
            ...
            <div class="table-responsive">
                <table class="table table-togglable table-hover">
                    ...
                    <tbody>
                                ...
                                <td align="center">
                                    <img src="http://localhost/editorberkelas/uploads/category/ffec-id_4821.png" width="75" />
                                </td>
                                <td align="left">FFEC ID</td>
                                <td><div style="text-align: center;  white-space: nowrap;">
                                        <div id_select="42" class="btn btn-success edit">Edit</div>                                        <div id_select="42" class="btn btn-danger hapus">Hapus</div>                                </div></td>                                          
                            </tr>
                                ...
                                <td align="center">
                                    <img src="http://localhost/editorberkelas/uploads/category/preset-guild_1236.png" width="75" />
                                </td>
                                <td align="left">Preset Guild</td>
                                <td><div style="text-align: center;  white-space: nowrap;">
                                        <div id_select="41" class="btn btn-success edit">Edit</div>                                        <div id_select="41" class="btn btn-danger hapus">Hapus</div>                                </div></td>                                          
                            </tr>
                                ...
                                <td align="center">
                                    <img src="http://localhost/editorberkelas/uploads/category/preset-3d_9163.png" width="75" />
                                </td>
                                <td align="left">Preset 3D</td>
                                <td><div style="text-align: center;  white-space: nowrap;">
                                        <div id_select="40" class="btn btn-success edit">Edit</div>                                        <div id_select="40" class="btn btn-danger hapus">Hapus</div>                                </div></td>                                          
                            </tr>
                                ...
                                <td align="center">
                                    <img src="http://localhost/editorberkelas/uploads/category/preset-bucin_6147.png" width="75" />
                                </td>
                                <td align="left">Preset Bucin</td>
                                <td><div style="text-align: center;  white-space: nowrap;">
                                        <div id_select="39" class="btn btn-success edit">Edit</div>                                        <div id_select="39" class="btn btn-danger hapus">Hapus</div>                                </div></td>                                          
                            </tr>
                                ...
                                <td align="center">
                                    <img src="http://localhost/editorberkelas/uploads/category/preset-kalimat_6732.png" width="75" />
                                </td>
                                <td align="left">Preset Kalimat</td>
                                <td><div style="text-align: center;  white-space: nowrap;">
                                        <div id_select="38" class="btn btn-success edit">Edit</div>                                        <div id_select="38" class="btn btn-danger hapus">Hapus</div>                                </div></td>                                          
                            </tr>
                                ...
                                <td align="center">
                                    <img src="http://localhost/editorberkelas/uploads/category/preset-profil_9273.png" width="75" />
                                </td>
                                <td align="left">Preset Profil</td>
                                <td><div style="text-align: center;  white-space: nowrap;">
                                        <div id_select="37" class="btn btn-success edit">Edit</div>                                        <div id_select="37" class="btn btn-danger hapus">Hapus</div>                                </div></td>                                          
                            </tr>
                                ...
                                <td align="center">
                                    <img src="http://localhost/editorberkelas/uploads/category/preset-lobby_2983.png" width="75" />
                                </td>
                                <td align="left">Preset Lobby</td>
                                <td><div style="text-align: center;  white-space: nowrap;">
                                        <div id_select="36" class="btn btn-success edit">Edit</div>                                        <div id_select="36" class="btn btn-danger hapus">Hapus</div>                                </div></td>                                          
                            </tr>
                                ...
                                <td align="center">
                                    <img src="http://localhost/editorberkelas/uploads/category/preset-trending_8146.png" width="75" />
                                </td>
                                <td align="left">Preset Trending</td>
                                <td><div style="text-align: center;  white-space: nowrap;">
                                        <div id_select="35" class="btn btn-success edit">Edit</div>                                        <div id_select="35" class="btn btn-danger hapus">Hapus</div>                                </div></td>                                          
                            </tr>
                                ...
                                <td align="center">
                                    <img src="http://localhost/editorberkelas/uploads/category/preset-baru_6283.png" width="75" />
                                </td>
                                <td align="left">Preset Baru</td>
                                <td><div style="text-align: center;  white-space: nowrap;">
                                        <div id_select="34" class="btn btn-success edit">Edit</div>                                        <div id_select="34" class="btn btn-danger hapus">Hapus</div>                                </div></td>                                          
                            </tr>
