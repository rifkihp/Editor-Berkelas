<?php
    ...
    $totalrecord = $db->getFieldValue("tabpanel AS A", array("COUNT(*) AS TOTAL"), array(),  array(), 0, 0, "", " 1 ");
    ...
    $listdetail = $db->getFieldValue("tabpanel AS A", array("A.id", "A.nama", "A.is_aktif"), array(), array(), $limit, $limit*($currentpage-1), " id DESC ",  " 1 "); 
    ...
    $smarty->assign("sub_page_selected", "tabpanel");    
    $smarty->assign("title", "Tab Menu");
    $smarty->assign("sub_title", "Daftar Tab Menu");
    ...
    $db->mysql_close();
    $smarty->display(BACK_END_TEMPLATE_PATH."/tabpanel/list.html");    