<?php
    ...
    foreach ($category as $key => $value) {
        ...
        foreach ($sub_category as $key_ => $value_) {
            ...
            $sub_sub_category = $db->getFieldValue("category AS A LEFT JOIN produk_to_category AS B ON B.id_kategori=A.id AND B.id_produk='$id'", array("A.id", "CONCAT('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;', A.nama) AS nama", "A. id_parent", "IF(B.id_kategori IS NOT NULL, 'Y', 'N') AS is_select"), array("A.id_parent" => $value_['id']));
